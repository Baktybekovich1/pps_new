...
class SocialActivitiesFixtures extends Fixture
{

    public function load(ObjectManager $manager)
    {
        $manager->persist((new SocialActivitiesList())->setName('Работы по кураторству академических групп')
        ...
        $manager->persist((new SocialActivitiesList())->setName('Награды, дипломы, грамоты, сертификаты, благодарности')
            ->addSocialActivitiesSubtitle((
            new SocialActivitiesSubtitle())
                ->setPoints(10))
        );
        ...
        $manager->persist((new SocialActivitiesList())->setName('Победитель')
            ...
            ->addSocialActivitiesSubtitle((
            new SocialActivitiesSubtitle())
                ->setName('Лучший преподаватель года зарубежных организаций')
                ->setPoints(40))
        );
